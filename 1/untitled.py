                    ...
                    if ii[0] == jj[0]:
                        ...
                        while (x != 0) or (y != 0):
                            ...
                            if pub != 0:
                                ...
                                new[1] = new[1] + x/abs(x)
                                x = x - x/abs(x)
                            neww = str(new[0]) + " " + str(int(new[1])) + " " + str(int(new[2]))
                            pst = str(pst[0]) + " " + str(int(pst[1])) + " " + str(int(pst[2]))
                            G.add_node(neww)
                            G.add_edge(neww, pst, 1)

                        # print(i, j.id, end="!!!\n")
                        if G.nodes[i].show_weight(j) > 1:
                            del G.nodes[i].neighbor[j]
...
def gsearch(data, G):
    ...
    while frontier != []:
        ...
        # for i in frontier:
        #     print (i[0].id, end="fff\n")
        # for i in explored_set:
        #     print (i[0].id, end="eee\n")
        # print("??")
...
def dsearch(data, G):
    ...
    while frontier != []:
        ...
        if node[0] == target:
            ...
            while explored_set != []:
                print(node[0])
                print(explored_set[-1][1])
                if explored_set[-1][1] == node[0]:
                    res = [node[0] + " " + "1"] + res
                    node = explored_set.pop()
                else:
                    explored_set.pop()
        ...
        explored_set = explored_set + [node]
        expand = G.nodes[node[0]].neighbor
        for new_node in expand:
            # print(node[0].id, end="node\n")
            # print(new_node)
            # print (explored_set)
